...
public class SingleBidirectionalManyToManyRelationJoinTable
{
    /*
      When mapping the intermediary join table, it's advisable to map only one side as a bidirectional @OneToMany association.
      Otherwise, removing the intermediary join entity will result in an additional SELECT statement. So in our Student, course
      and enrollment example, lets remove course side collection and keep Student @OneToMany association.
     */
    ...
    @EqualsAndHashCode (exclude = { "id", "courseDescription", "credits" })
    ...
    public static class Course
    {
        ...
        // With these annotations in place, we can fetch the Course entity without needing to hit the database@Id
